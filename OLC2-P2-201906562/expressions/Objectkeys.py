...
class ObjectKeys(Expression):
    ...
    def ejecutar(self, ast, env, gen, lvlbreak, lvlcont, lvlreturno):
        ...
        # resp = env.getInterace(self.line, self.col, ast, res.type.name)

        # SYMATRIB = resp["conte"]
        # array = []
        # for attri in SYMATRIB.value:
        #     temp = Symbol(SYMATRIB.line, SYMATRIB.col, attri, SYMATRIB.value[attri] )
        #     array.append(temp)
